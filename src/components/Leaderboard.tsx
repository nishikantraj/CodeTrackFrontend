    ...
    return (
      <div className="flex justify-center items-center">
        <div className="flex items-center space-x-4">
          <Skeleton className="h-12 w-12 rounded-full bg-cyan-300" />
          <div className="space-y-2 bg-[#ABB3C6] flex justify-center items-center">
            <div className="flex justify-center items-center">
              <p className="text-center px-5 text-2xl">Data fetching...</p>
            </div>
            <div>
