            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ml-auto text-sm text-[#3DDC97] underline-offset-2 hover:underline"
                  >
              ...
              <Button type="submit" className="w-full bg-[#3DDC97] text-black hover:bg-[#32c386] cursor-pointer">
                Login
              </Button>
              ...
              <div className="text-center text-sm text-gray-400">
                ...
                <a href="#" className="underline text-[#3DDC97]">Sign up</a>
              </div>
            </div>
          </form>
